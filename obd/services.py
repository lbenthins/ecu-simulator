...
SERVICES = [
    {"id": 0x01, "description": "Show current data",
     "pids": [
         {"id": 0x05, "description": "Engine coolant temperature", "response": ecu_info.get_engine_temperature()},
         {"id": 0x0D, "description": "Vehicle speed", "response": ecu_info.get_vehicle_speed()},
         {"id": 0x2F, "description": "Fuel tank level input", "response": ecu_info.get_fuel_level()},
         {"id": 0x51, "description": "Fuel type", "response": ecu_info.get_fuel_type()}
     ]},
    {"id": 0x03, "description": "Show DTCs", "response": ecu_info.get_dtcs()},
    {"id": 0x09, "description": "Request vehicle information",
     "pids": [
         {"id": 0x02, "description": "Vehicle Identification Number(VIN)", "response": ecu_info.get_vin()},
         {"id": 0x0A, "description": "ECU name", "response": ecu_info.get_ecu_name()}
     ]}
]
